...
export async function addInterfaceInfoUsingPOST(
  ...
  return request<API.BaseResponselong>(baseUrl+'/api/backend/interfaceInfo/add', {
    method: 'POST',
    headers: {
...
export async function deleteInterfaceInfoUsingPOST(
  ...
  return request<API.BaseResponseboolean>(baseUrl+'/api/backend/interfaceInfo/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getInterfaceInfoByIdUsingGET(
  ...
  return request<API.BaseResponseInterfaceInfo>(baseUrl+'/api/backend/interfaceInfo/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listInterfaceInfoUsingGET(
  ...
  return request<API.BaseResponseListInterfaceInfo>(baseUrl+'/api/backend/interfaceInfo/list', {
    credentials:'include',
    method: 'GET',
    params: {
      ...params,
...
export async function listInterfaceInfoByPageUsingGET(
  ...
  return request<API.BaseResponsePageInterfaceInfo>(baseUrl+'/api/backend/interfaceInfo/list/page', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function offlineInterfaceInfoUsingPOST(
  ...
  return request<API.BaseResponseboolean>(baseUrl+'/api/backend/interfaceInfo/offline', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function onlineInterfaceInfoUsingPOST(
  ...
  return request<API.BaseResponseboolean>(baseUrl+'/api/backend/interfaceInfo/online', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateInterfaceInfoUsingPOST(
  ...
  return request<API.BaseResponseboolean>(baseUrl+'/api/backend/interfaceInfo/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
